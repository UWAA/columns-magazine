<?php
/*
Template Name: Video Media
Template Post Type: media
*/
...
<div class="columns-feature-content">
    <div class="row"><?php the_content(); ?><?php  if (get_field("columns_tagline") != '') {     ?>

        <hr>
        <p class="final-byline"><?php echo get_field('columns_tagline'); ?>
