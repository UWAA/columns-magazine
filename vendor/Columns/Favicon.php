...
class Favicon
{
    ...
    ?>
    <link rel="apple-touch-icon" sizes="57x57" href="<?php echo get_stylesheet_directory_uri() ?><?php echo get_stylesheet_directory_uri() ?>/assets/favicon/favicon/apple-icon-57x57.png">
